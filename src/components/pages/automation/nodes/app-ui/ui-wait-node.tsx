...
export function UIWaitNode({ id, data, selected }: NodeProps<Node<UIWaitData>>) {
  return (
    <BaseNode id={id} label={data.label} status={data.status} nodeKind="uiWait" icon={Clock3} selected={selected}>
