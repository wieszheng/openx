...
export function UISwipeNode({ data, selected }: NodeProps<Node<UISwipeData>>) {
  return (
    <BaseNode label={data.label} status={data.status} nodeKind="uiSwipe" icon={Move} selected={selected}>
