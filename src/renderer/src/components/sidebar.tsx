  ...
  return (
    <aside className="w-14 flex flex-col items-center py-3">
      ...
      <div className="w-9.5 h-9.5 flex items-center justify-center mb-3">
        <svg width="48" height="48" viewBox="0 0 100 100" fill="none" stroke="oklch(0.508 0.118 165.612)" stroke-linecap="round" stroke-linejoin="round"  xmlns="http://www.w3.org/2000/svg"><circle cx="26" cy="34" r="14" fill="oklch(0.508 0.118 165.612)" stroke="none"><animate attributeName="r" values="14; 2; 14; 14; 14" dur="4s" keyTimes="0; 0.05; 0.1; 0.5; 1" repeatCount="indefinite"></animate></circle><path d="M 60 20 L 86 46 M 86 20 L 60 46" stroke-width="18"><animateTransform attributeName="transform" type="rotate" values="0 73 33; 360 73 33" dur="4s" repeatCount="indefinite"></animateTransform></path><path d="M 16 76 Q 38 52 56 76 T 88 72" stroke-width="18"><animate attributeName="d" values="M 16 76 Q 38 52 56 76 T 88 72; M 16 72 Q 38 56 56 72 T 88 76; M 16 76 Q 38 52 56 76 T 88 72" dur="4s" repeatCount="indefinite"></animate></path></svg>
      ...
      <div className="mt-auto flex flex-col gap-1">
        ...
        {/* 设置 */}
        <button
          className={`w-10 h-10 flex items-center justify-center rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent transition-all duration-200                 ${activeMenu === 'settings'
            ? 'text-primary'
            : 'text-muted-foreground hover:text-foreground hover:bg-accent'
            }`}
          title="设置"
